            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Product Add
                            <a href="<?= base_url('trouser'); ?>" class="btn btn-danger float-end">BACK</a>
                        </h4>
                    </div>
                    <div class="card-body">
                        <form action="<?= base_url('trouser/store'); ?>" method="POST">
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <button type="submit" name="trouser" class="btn btn-primary">Save Product</button>
                            </div>
