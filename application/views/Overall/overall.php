            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 id="tableName">Product Details (Overall)</h4>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="<?= base_url('overall/add'); ?>" method="POST">
                                            <div class="mb-3">
                                                <input type="text" name="epfno" class="form-control" required>
                                            </div>
                                            <div class="modal-footer">
                                                <button type="submit" name="epfadd-overall" class="btn btn-primary">ADD</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
                            ...
                            <tbody>
                                <?php foreach ($overall as $row) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?= base_url('overall/edit/' . $row->id); ?>" title="Edit data & Send Email" class="btn btn-success btn-sm"><i class="fa-regular fa-pen-to-square"></i></a>
                                        </td>
                                        <td>
                                            <a href="<?= base_url('overall/tableupdate/' . $row->id); ?>"  title="Update Used Date" class="btn btn-success btn-sm"><i class="fa-sharp fa-solid fa-wrench"></i></a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
