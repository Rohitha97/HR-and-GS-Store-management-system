            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Product Add
                            <a href="<?= base_url('overall'); ?>" class="btn btn-danger float-end">BACK</a>
                        </h4>
                    </div>
                    <div class="card-body">
                        <form action="<?= base_url('overall/store'); ?>" method="POST">
                        <div class="mb-3">
                            ...
                            <div class="form-group mb-3">
                                <label for="exampleFormControlTextarea1" class="form-label">Issue Date</label>
                                <input type="date" name="idate" class="form-control" require>
                            </div> -->
                            <!-- <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <button type="submit" name="overall" class="btn btn-primary">Save Product</button>
                            </div>
