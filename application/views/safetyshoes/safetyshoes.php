            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 id="tableName">Product Details (Safetyshoes)</h4>
                    ...
                    <div class="card-body">
                        <table id="datatable" class="table table-striped">
                            ...
                            <tbody>
                                <?php foreach ($safetyshoes as $row) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?= base_url('safetyshoes/edit/' . $row->id); ?>" title="Edit data & Send Email" class="btn btn-success btn-sm"><i class="fa-regular fa-pen-to-square"></i></a>
                                        </td>
                                        <td>
                                            <a href="<?= base_url('safetyshoes/tableupdate/' . $row->id); ?>"  title="Update Used Date" class="btn btn-success btn-sm"><i class="fa-sharp fa-solid fa-wrench"></i></a>
                                        </td>
