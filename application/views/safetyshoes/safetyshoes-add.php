            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Product Add 
                            <a href="<?= base_url('safetyshoes'); ?>" class="btn btn-danger float-end">BACK</a>
                        </h4>
                    </div>
                    <div class="card-body">
                        <form action="<?= base_url('safetyshoes/store'); ?>" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="spn" class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
                            </div>
                            <div class="mb-3">
                                <button type="submit" name="safetyshoes" class="btn btn-primary">Save Product</button>
                            </div>
